...
- Use `-n 4 -g --open` when exploring options — never run parallel shell jobs as a substitute for `-n N`. When exploring, **vary styles across prompts** (photorealistic, illustrated, cartoony, sketch, minimalist) to find the right register in round 1, not round 2.
