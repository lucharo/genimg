...
The first time the user states a lasting preference about their images (a style, a palette, "always sober"), create a `genimg-preferences` skill and record the preference in the user's words. Add later preferences to the same file. Create it only once the user has stated a preference; a guess about their taste stays out of it.
