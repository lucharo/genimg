...
The original review baseline is `a9fb22778936b3b27c7a7ea7fca84781c95b4150`, tree-equivalent to takeover commit `19d76c98167e4efc97332d3df53d17fcd07fe927`. This preservation change also excludes `/artifacts` and `/handoffs` from the source distribution; the review remains in Git without enlarging the installable package. Product runtime code is unchanged. The canonical checkout was dirty and divergent on 24 September and was preserved. Fetch current remote state and use a fresh worktree; do not reset, stash or overwrite the canonical checkout to resume.
