...
<video class="demo" src="assets/demos/generate.mp4" poster="assets/demos/generate.webp" width="1266" height="736" autoplay loop muted playsinline title="genimg writing four fox logos and a grid from one command"></video>

A real run. The 39-second wait plays at 6x speed.
