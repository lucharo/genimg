...
```bash
genimg grid fox-1.webp fox-2.webp fox-3.webp fox-4.webp \
  --open
```
...
until one is left: eight images take seven picks. Tick **Top 3** for a third place.
...
winner, the ranking and every pick.

## Try it for yourself

This is the grid the first command wrote. Press **Tournament**, or switch to the carousel.

<iframe src="../../assets/grid-demo.html" title="A live genimg grid of four fox logos"
  loading="lazy" allow="clipboard-write"
  style="width: 100%; height: 900px; border: 0; border-radius: 10px;"></iframe>
